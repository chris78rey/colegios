...
- colegios-rc-validacion-web: Runbook for the web admin identity validation flow in colegios. Use when implementing or modifying cedula-based external validation, corrected Excel download, standard 12-column signer sheets, or OmniSwitch preflight checks in the web admin/API. (file: G:/codex_projects/colegios/.codex/skills/colegios-rc-validacion-web/SKILL.md)
